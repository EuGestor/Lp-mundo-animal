...
const products: Product[] = [
  ...
  },
  {
    ...
    price: 130.0,
    image: '/assets/colosso-filhotes.jpg',
    category: 'Cães',
    weight: '10,1kg',
    description: 'Alimento completo para o desenvolvimento de filhotes de todas as raças. A nutrição certa pra primeira fase da vida do seu cachorro, sem corantes e aromatizantes artificiais.',
    benefits: [
      'Alta digestibilidade: formulada para o sistema sensivel dos filhotes',
      'Omega 3 e 6: pele saudável e pelagem brilhante desde cedo',
      'Calcio e fosforo balanceados: ossos e dentes fortes em desenvolvimento',
      'Reduzido teor de sodio: apoio cardiovascular',
      'Extrato de Yucca Schidigera: fezes com menos odor',
    ],
  },
  {
    id: 4,
  ...
  },
  {
    id: 8,
    originalPrice: 145.0,
    name: 'Colosso Premium Gatos Frango & Arroz',
    price: 130.0,
    image: '/assets/colosso-gatos-premium.jpg',
    category: 'Gatos',
    weight: '10,1kg',
    description: 'Alimento completo para todas as fases da vida do seu gato. Nutrição equilibrada para gatas em gestação/lactação, filhotes e adultos de todas as raças. Sem corantes e aromatizantes artificiais.',
    benefits: [
      'Taurina: saúde da visão e do coraçao',
      'Alta digestibilidade: maxima absorcao de nutrientes',
      'Controle de pH urinário: trato urinário saudável',
      'Omega 3 e 6: pele e pelagem brilhantes',
      'Extrato de Yucca Schidigera: reducao do odor das fezes',
    ],
  },
  {
    id: 9,
    originalPrice: 145.0,
    name: 'Colosso Premium Gatos Salmao & Arroz',
    price: 130.0,
    image: '/assets/colosso-gatos-premium.jpg',
    category: 'Gatos',
    weight: '10,1kg',
    description: 'Alimento completo para todas as fases da vida do seu gato. Nutrição equilibrada para gatas em gestação/lactação, filhotes e adultos de todas as raças. Com oleo de salmao. Sem corantes e aromatizantes artificiais.',
    benefits: [
      'Taurina: saúde da visão e do coraçao',
      'Alta digestibilidade: maxima absorcao de nutrientes',
      'Controle de pH urinário: trato urinário saudável',
      'Omega 3 (oleo de salmao): pelagem brilhante',
      'Extrato de Yucca Schidigera: reducao do odor das fezes',
    ],
  },
  {
    id: 10,
    originalPrice: 145.0,
    name: 'Colosso Premium Gatos Castrados Carne',
    price: 130.0,
    image: '/assets/colosso-gatos-premium.jpg',
    category: 'Gatos',
    weight: '10,1kg',
    description: 'Formulaçao especifica para gatos adultos castrados. Apos a castraçao, o metabolismo muda. Essa formula e pensada para manter o peso ideal e proteger o trato urinário: pontos criticos pra essa fase.',
    benefits: [
      'Controle de pH urinário: prevencao de problemas urinários comuns em castrados',
      'Hairball Control: auxilia no controle de bolas de pelo',
      'Taurina: visão e coraçao',
      'Omega 3 e 6: pele saudável e pelos brilhantes',
  ...
  },
  {
    id: 11,
    originalPrice: 145.0,
    name: 'Colosso Premium Gatos Castrados Salmao',
    price: 130.0,
    image: '/assets/colosso-gatos-premium.jpg',
    category: 'Gatos',
    weight: '10,1kg',
    description: 'Formulaçao especifica para gatos adultos castrados. Apos a castraçao, o metabolismo muda. Essa formula e pensada para manter o peso ideal e proteger o trato urinário. Com sabor salmao.',
    benefits: [
      'Controle de pH urinário: prevencao de problemas urinários comuns em castrados',
      'Hairball Control: auxilia no controle de bolas de pelo',
      'Taurina: visão e coraçao',
      'Omega 3 (oleo de salmao): pele saudável e pelos brilhantes',
      'Alta digestibilidade',
      'Extrato de Yucca Schidigera: fezes com menos odor',
    ],
  },
  {
    id: 12,
    originalPrice: 145.0,
    name: 'Colosso Premium Gatos Castrados Frango',
    price: 130.0,
    image: '/assets/colosso-gatos-premium.jpg',
    category: 'Gatos',
    weight: '10,1kg',
    description: 'Formulaçao especifica para gatos adultos castrados. Formula balanceada com fibras e prebióticos que auxiliam no controle de peso e saúde urinária.',
    benefits: [
      'Formulado especialmente para gatos adultos castrados com aditivo acidificante e prebióticos',
      'Controle de bola de pelos e trato urinário saudável',
      'Alta digestibilidade e sem corantes artificiais',
    ],
  },
  {
    id: 13,
  ...
  },
  {
    id: 21,
    originalPrice: 42.0,
    name: 'Colosso Roupinha de La',
    price: 35.0,
    image: '/assets/colosso-roupinha.jpg',
    category: 'Acessorios',
    weight: 'P/M/G',
    description: 'Conforto e protecao contra o frio para o seu pet. Roupinha em malha de la com gola canelada e acabamento em trico. Estampas listradas sortidas (verde, marrom/azul, lilas).',
    benefits: [
      'Aquece nos dias frios: especialmente util para cães de pelo curto',
      'Tecido resistente e duravel',
      'Modelagem que prioriza o movimento: sem botoes nem ziperes',
      'Estampas sortidas: variedade de cores',
      'Indicada para cães de pequeno e medio porte',
    ],
  },
  {
    id: 22,
